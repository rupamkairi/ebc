      ...
      <Container size="lg">
        ...
        <div className="flex flex-col items-center gap-3 pt-6">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-3 bg-white/50 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm border border-slate-100"
            >
    ...
    <div className="py-12 bg-slate-50/50">
      <Container size="lg">
        <div className="text-center mb-10">
          <h2 className="text-lg md:text-xl font-black text-[#445EB4] uppercase tracking-wider">
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col group h-full">
      <div className="bg-[#4D4D4D] p-4 text-center group-hover:bg-[#445EB4] transition-colors duration-500">
        <h3 className="text-white text-[13px] md:text-sm font-black uppercase tracking-tight line-clamp-1">
          {product.title}
        </h3>
      </div>
