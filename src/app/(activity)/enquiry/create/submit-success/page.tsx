  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] py-12 px-4 text-center space-y-8 animate-in fade-in zoom-in duration-500">
      ...
      <div className="space-y-3 max-w-lg">
        <h1 className="text-4xl font-black text-primary tracking-tight  italic italic-none">
          {t("enquiry_submitted")}
        </h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-6 w-full max-w-md">
        <Button
          asChild
          variant="outline"
          className="flex-1 h-12 rounded-xl border-primary/20 text-primary/60 font-black text-[11px]   hover:bg-primary/5 hover:border-primary/30 transition-all"
        >
          <Link href="/browse">{t("browse_more_items")}</Link>
        </Button>
        <Button
          asChild
          className="flex-1 h-12 rounded-xl bg-primary hover:bg-primary/90 text-white font-black text-[11px]   shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-95 border-none"
        >
