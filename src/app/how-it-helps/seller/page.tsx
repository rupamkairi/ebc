...
import { DashboardCard } from "@/app/(dashboard)/seller-dashboard/dashboard-card";
          ...
          <div className="container mx-auto px-4 relative z-10 text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <Link href="/auth/login?role=seller" className="w-full sm:w-auto">
                <Button size="lg" className="bg-secondary hover:bg-secondary/90 w-full h-16 px-12 text-lg font-black rounded-xl gap-3 shadow-xl shadow-secondary/20 group">
        ...
        <section className="py-16 bg-muted/20">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <DashboardCard title="Maximize Profit." icon={TrendingUp}>
                <div className="space-y-4">
                  <p className="font-bold text-foreground/70 leading-relaxed">
                    Pay-per-lead via Coin Wallet for high-intent enquiries. Protect margins with negotiable quotations.
                  </p>
                  <ul className="space-y-2 text-xs font-bold text-foreground/40">
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> Negotiable Quotations</li>
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> Bulk Order Leads</li>
                  </ul>
                </div>
              </DashboardCard>

              <DashboardCard title="Scale Operations." icon={Settings2}>
                <div className="space-y-4">
                  <p className="font-bold text-foreground/70 leading-relaxed">
                    Integrated logistics with LSPs & LTL carriers. Connect with a wide network of dealers & wholesalers.
                  </p>
                  <ul className="space-y-2 text-xs font-bold text-foreground/40">
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> Logistics Support</li>
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> Dealer Network</li>
                  </ul>
                </div>
              </DashboardCard>

              <DashboardCard title="Future-Proof Tech." icon={Cpu}>
                <div className="space-y-4">
                  <p className="font-bold text-foreground/70 leading-relaxed">
                    AI-powered Smart Matching. Integrated e-invoicing IRP support. Actionable data analytics.
                  </p>
                  <ul className="space-y-2 text-xs font-bold text-foreground/40">
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> AI Matching</li>
                    <li className="flex items-center gap-2"><div className="size-1.5 bg-primary rounded-full" /> Compliance Tools</li>
                  </ul>
                </div>
              </DashboardCard>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-black text-foreground mb-4">{t("seller_path_retailer")} & {t("seller_path_professional")} Paths</h2>
              <p className="text-foreground/60 font-bold italic">Tailored toolsets for your growth</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="p-10 rounded-[2.5rem] bg-white border border-border shadow-lg flex flex-col items-center text-center space-y-6 group hover:border-primary/50 transition-colors">
                ...
                <h3 className="text-2xl font-black italic">{t("seller_path_retailer")} & Dealer Dashboard</h3>
                <p className="text-foreground/60 font-medium">Control sourcing costs, manage inventory visibility, and get higher margins with direct inquiries.</p>
              ...
              <div className="p-10 rounded-[2.5rem] bg-white border border-border shadow-lg flex flex-col items-center text-center space-y-6 group hover:border-secondary/50 transition-colors">
                ...
                <h3 className="text-2xl font-black italic">Consultant & Specialist</h3>
                <p className="text-foreground/60 font-medium">Monetize your expertise, get verified job requirements, and manage workforce scheduling.</p>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-12 bg-white p-8 md:p-16 rounded-[3rem] border border-border shadow-sm">
              <div className="space-y-6 max-w-xl">
                <h2 className="text-3xl md:text-5xl font-black leading-tight text-foreground">Verified Compliance & Secure Operations</h2>
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center gap-2">
                    <ShieldCheck className="text-emerald-500 size-5" />
                    <span className="font-bold text-foreground/70 italic">Fraud Detection</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <ShieldCheck className="text-emerald-500 size-5" />
                    <span className="font-bold text-foreground/70 italic">Secure Payouts</span>
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-8 text-center bg-muted/30 p-10 rounded-3xl border border-border">
                <div className="space-y-1">
                  ...
                  <div className="text-[10px] uppercase font-bold text-foreground/40">Retailers</div>
                </div>
                <div className="space-y-1">
                  <div className="text-3xl font-black text-primary">2004</div>
                  <div className="text-[10px] uppercase font-bold text-foreground/40">Est. Year</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="relative group">
              ...
              <div className="relative bg-white rounded-[3rem] p-12 md:p-20 text-center border border-border overflow-hidden shadow-xl">
                ...
                <Link href="/auth/login?role=seller" className="w-full sm:w-auto">
                  <Button size="lg" className="bg-primary hover:bg-primary/90 h-20 px-16 text-2xl font-black rounded-2xl shadow-2xl shadow-primary/20 group/btn">
                    JOIN EBC TODAY!
                    <ArrowRight className="size-6 group-hover/btn:translate-x-2 transition-transform" />
                  </Button>
                </Link>
                <p className="mt-8 text-foreground/40 text-xs font-black tracking-[0.4em] uppercase">India&apos;s Premier Digital Construction Ecosystem</p>
              </div>
            </div>
          </div>
        </section>
