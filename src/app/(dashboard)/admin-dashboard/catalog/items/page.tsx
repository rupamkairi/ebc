...
export default function ItemsPage() {
  return (
    <div className="flex flex-col gap-4 p-4 md:p-8 min-w-0 w-full overflow-x-hidden">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Dialog>
            ...
            <DialogContent className="w-full max-w-[95vw] md:max-w-xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
