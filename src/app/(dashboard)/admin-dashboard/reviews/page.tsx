    ...
    <div className="flex flex-col gap-8 p-6 max-w-7xl mx-auto">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground text-sm max-w-2xl">
          Monitor and manage reviews that have been hidden by sellers. As an
          admin, you can restore transparency by unhiding legitimate feedback or
          keeping inappropriate content suppressed.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <Button
          variant="outline"
          className="h-14 px-6 rounded-2xl font-bold gap-2"
        >
        ...
        <Card className="border-dashed bg-muted/20">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-muted-foreground text-sm">
              Everything looks transparent across the platform.
            </p>
          </CardContent>
        </Card>
      ) : (
