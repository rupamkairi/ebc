...
export default function AppointmentsPage() {
  ...
  const [selectedAssignment, setSelectedAssignment] =
    React.useState<ActivityAssignment | null>(null);
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap items-center gap-x-8 gap-y-2 text-sm font-bold text-foreground/40 italic">
                            <div className="flex items-center gap-2">
                              ...
                              {slot
                                ? format(new Date(slot.fromDateTime), "PPP p")
                                : format(new Date(apt.createdAt), "PPP")}
                            </div>
                            <div className="flex items-center gap-3">
                        ...
                        {apt.status === "PENDING" ? (
                          <div className="flex flex-col items-center gap-4 w-full md:w-auto">
                            ...
                            >
                              ...
                              <Button
                                onClick={() =>
                                  slot?.id && handleConfirm(apt.id, slot.id)
                                }
