    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6">
        {appointments.map((apt) => (
          <Card key={apt.id} className="border-none shadow-sm hover:shadow-xl transition-all overflow-hidden group bg-white rounded-4xl">
            <CardContent className="p-0">
              <div className="flex flex-col md:flex-row">
                {/* Urgency Stripe */}
                <div className={`w-full md:w-2 h-2 md:h-auto ${
                  apt.urgency === 'High' ? 'bg-rose-500' : 'bg-primary/30'
                }`} />
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <h3 className="text-2xl font-black text-foreground italic">
                        {apt.type} with <span className="text-primary">{apt.customer}</span>
                      </h3>
