      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h1 className="text-3xl font-black text-foreground tracking-tight">
            {t("service_area_management_title")}
          </h1>
          <p className="text-foreground/60 font-medium">
            {t("manage_areas_provide_delivery")}
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-amber-50 border border-amber-100 p-6 rounded-3xl space-y-3">
            ...
            <p className="text-xs font-medium text-amber-700/60 leading-relaxed italic">
              {t("extension_pending_verification")}
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="p-6 flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    <div className="flex gap-4">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-3">
                          ...
                          <Badge
                            className={` tracking-tighter font-black text-[9px] rounded-full px-2 py-0 h-4 border-none ${
                              loc.status === "Active"
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-8 w-full sm:w-auto">
                      <div className="text-right">
                        <p className="text-[10px] font-black   text-foreground/40">
                          {loc.type}
                        </p>
                      ...
                      <div className="flex items-center gap-2">
                        <Button
                          variant="ghost"
                          size="icon"
                          className="rounded-xl text-foreground/20 hover:text-rose-500 transition-colors"
                        >
                          <Trash2 size={18} />
                        </Button>
                        <Button
                          variant="ghost"
                          size="icon"
                          className="rounded-xl text-foreground/20 hover:text-primary"
                        >
          ...
          <div className="flex justify-center pt-4">
            <Button
              variant="ghost"
              className="text-foreground/30 font-black flex items-center gap-2 group italic text-sm"
            >
