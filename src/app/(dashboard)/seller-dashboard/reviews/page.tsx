  ...
  return (
    <div
      className={cn(
        ...
        review.isPinned ? "ring-2 ring-secondary/40" : "",
      )}
    >
      {/* Pinned badge */}
      {review.isPinned && (
        <div className="absolute -top-2.5 left-5 px-3 py-0.5 bg-secondary text-white text-[9px] font-black   rounded-full flex items-center gap-1">
      ...
      <div className="relative pl-6">
        <span className="absolute left-0 top-0 text-secondary text-4xl font-black leading-none">
          &ldquo;
        </span>
        {review.title && (
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        {review.isVerified && (
          <span className="text-[9px] font-black   bg-green-500/20 text-green-300 border border-green-500/30 px-2 py-0.5 rounded-full">
            Verified
          </span>
        )}
        {review.isHidden && (
          <span className="text-[9px] font-black   bg-red-500/20 text-red-300 border border-red-500/30 px-2 py-0.5 rounded-full flex items-center gap-1">
    ...
    <div className="flex flex-col gap-8">
        ...
        {!summary || summary.total === 0 ? (
          <div className="flex flex-col items-center justify-center py-10 gap-3">
            ...
            <p className="text-gray-400 font-medium text-sm">
              {t("no_ratings_yet_complete_enquiries")}
            </p>
          </div>
        ) : (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
        {[
          {
            icon: Star,
            label: t("average_rating_score"),
            value: avgRating.toFixed(1),
          },
          {
            icon: MessageSquare,
            label: t("total_feedbacks"),
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-white/80 text-xs font-semibold leading-tight truncate">
                {label}
              </p>
              <p className="text-white text-2xl md:text-3xl font-black leading-none mt-0.5">
                {value}
              </p>
            </div>
          </div>
