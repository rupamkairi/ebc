    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="relative">
        ...
        <input 
          ...
          className="w-full bg-white border border-border rounded-2xl py-4 l-12 pr-4 text-sm font-medium focus:ring-2 focus:ring-primary/20 outline-none transition-all shadow-sm"
        />
      </div>
