            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-muted/30 p-4 rounded-xl space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    variant="outline"
                    className="h-9 rounded-lg border-primary text-primary hover:bg-primary/5 text-xs font-bold"
                  >
                    REJECT
                  </Button>
              ...
              <Button
                variant="ghost"
                className="w-full text-secondary font-black text-sm py-2 group"
              >
