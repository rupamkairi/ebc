      ...
      {status && status !== "APPROVED" && (
        ...
        >
          ...
          <Button
            ...
            className={cn(
              "bg-white",
              status === "PENDING" && "border-amber-200 hover:bg-amber-100",
              status === "REJECTED" &&
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <DashboardCard
                  ...
                  contentComponent={
                    <p className="text-sm text-foreground/60 italic mt-2 leading-relaxed">
                      Apna pura product range, specs aur technical sheets upload
                      karein.
                    </p>
                  }
                />
              ...
              >
                <DashboardCard
                  ...
                  iconComponent={
                    <CalendarDays size={20} className="text-foreground/40" />
                  }
                  contentComponent={
              ...
              >
                <DashboardCard
                  ...
                  className="group-hover:bg-muted/50 transition-all cursor-pointer"
                  iconComponent={
                    <FileSearch size={20} className="text-foreground/40" />
                  }
                  contentComponent={
                    <div className="flex items-center gap-2 mt-4 text-xs font-bold text-foreground/40 italic">
                      8 Sent · 3 Pending
              ...
              <div className="grid grid-cols-1 gap-4 h-full">
                <Link href="/seller-dashboard/support" className="group">
                  <DashboardCard
                    ...
                    iconComponent={
                      <Headphones className="text-foreground/30" />
                    }
                    className="group-hover:bg-muted/30 transition-all cursor-pointer h-full"
                  />
                </Link>
          ...
          <div className="p-8 rounded-4xl bg-indigo-600 text-white space-y-6 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs font-medium text-white/70 leading-relaxed mb-6">
                Advertise your latest products directly to verified dealer
                networks and get higher visibility.
              </p>
