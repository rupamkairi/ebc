    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] gap-4">
        <p className="text-xl font-bold">
          {t("quotation_not_found", "Quotation not found")}
        </p>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4 justify-between bg-white p-6 rounded-2xl border border-primary/5 shadow-xs">
          <div className="flex items-center gap-3">
            ...
            {isAccepted && (
              <Badge className="bg-emerald-500 text-white font-black  text-[10px]  px-3">
                Accepted
              </Badge>
            )}
            {q.quotationDetails?.[0]?.hasBeenRevised && (
          ...
          <div className="flex items-center gap-3">
            ...
            {(isAccepted || isEnquiryCompleted) && (
              <div
                className={cn(
                  "flex items-center gap-3 px-6 h-11 rounded-xl border font-black text-xs  ",
                  isAccepted
              ...
              >
                ...
                <span>
                  {isAccepted ? t("offer_accepted") : t("enquiry_closed")}
                </span>
              </div>
            )}
          </div>
