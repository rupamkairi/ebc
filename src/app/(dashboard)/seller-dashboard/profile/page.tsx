              ...
              <div className="flex flex-col md:flex-row md:items-end gap-6">
                ...
                <div className="pb-4 space-y-2">
                  <div className="flex items-center gap-3">
                    <h1 className="text-3xl font-black text-foreground tracking-tight">Rajesh Kumar Enterprises</h1>
                  ...
                  <CardContent className="p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black uppercase tracking-widest text-foreground/30">Owner Name</label>
                        <input type="text" defaultValue="Rajesh Kumar Malhotra" className="w-full bg-muted/50 border border-border rounded-xl px-4 py-3 font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black uppercase tracking-widest text-foreground/30">Email Address</label>
                        <input type="email" defaultValue="rajesh.kumar@rkent.com" className="w-full bg-muted/50 border border-border rounded-xl px-4 py-3 font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-black uppercase tracking-widest text-foreground/30">Mobile Number</label>
                        <input type="tel" defaultValue="+91 98765 43210" className="w-full bg-muted/50 border border-border rounded-xl px-4 py-3 font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
