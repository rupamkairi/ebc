                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      readOnly
                      value={legalName}
                      className="w-full bg-muted/30 border border-border rounded-xl px-4 py-3 font-bold outline-none cursor-not-allowed opacity-70"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black uppercase tracking-widest text-foreground/30">
                ...
                <div className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="url"
                        defaultValue="https://rk-enterprises.ebc.com"
                        className="w-full bg-muted/50 border border-border rounded-xl px-4 py-3 pl-10 font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all text-primary"
                      />
                    </div>
                  </div>
        ...
        <TabsContent value="business" className="mt-0">
          ...
          <Card className="border-none shadow-sm p-12 text-center text-foreground/20">
            ...
            <p className="font-bold italic">
              Business profile management tools coming soon.
            </p>
          </Card>
        </TabsContent>
      </Tabs>
