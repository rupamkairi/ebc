        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
               <Badge className="bg-primary px-3 py-1 font-black">EXCLUSIVE PROMOTION</Badge>
               {offer.isActive && <Badge variant="outline" className="text-green-600 border-green-200">Active Offer</Badge>}
            </div>
          ...
          <Card className="relative border-none bg-linear-to-br from-primary to-primary-foreground/90 overflow-hidden rounded-4xl shadow-2xl shadow-primary/20">
             ...
             <CardContent className="p-12 relative text-white space-y-6">
                ...
                <h2 className="text-4xl font-black max-w-md">Connect with the provider to claim this offer</h2>
                <div className="flex flex-wrap gap-4 pt-4">
                   <Button size="lg" className="bg-white text-primary hover:bg-white/90 rounded-2xl h-16 px-10 font-black text-lg gap-2 shadow-xl">
        ...
        <div className="space-y-8">
          <Card className="border-none bg-muted/30 rounded-4xl p-2">
            <CardHeader className="pb-4">
              <CardTitle className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground">Offer Timeline</CardTitle>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-start gap-4 p-4 bg-white rounded-3xl shadow-sm">
                ...
                <div>
                  <p className="text-[10px] font-black text-muted-foreground uppercase">Validity Period</p>
                  <p className="font-extrabold text-foreground">
                    {detail?.startDate ? format(new Date(detail.startDate), "PPP") : "TBD"}
                    {" — "}
                    {detail?.endDate ? format(new Date(detail.endDate), "PPP") : "Ongoing"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-3xl shadow-sm">
                ...
                <div>
                  <p className="text-[10px] font-black text-muted-foreground uppercase">Published On</p>
                  <p className="font-extrabold text-foreground">
                    {detail?.publishedAt ? format(new Date(detail.publishedAt), "PPP") : "Awaiting Publication"}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-none bg-linear-to-b from-primary/5 to-transparent rounded-4xl">
             <CardContent className="p-8 space-y-6">
                <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest">About the Promoter</p>
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      <h4 className="font-black text-xl leading-none">{offer.entity?.name}</h4>
                ...
                <div className="pt-4">
                   <Button variant="ghost" className="w-full rounded-xl h-12 font-bold justify-between group">
                      Visit Brand Hub
