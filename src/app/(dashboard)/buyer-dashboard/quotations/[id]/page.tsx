          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              <h4 className="font-black text-violet-900">
                Quotation Reconsidered
              </h4>
              <p className="text-sm text-violet-700 font-medium">
                The seller has reviewed your revision request and updated the
                proposal.
                ...
                {q.priceChangeType === "DECREASED" &&
                  !q.priceDifference &&
                  " They have specially reduced the price for you!"}
                ...
                {q.priceChangeType === "MAINTAINED" &&
                  " The original pricing has been maintained."}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-orange-700 font-medium">
                  Your request for a price reconsideration has been sent. We are
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              {q.quotationDetails?.[0]?.hasBeenRevised && (
                <Badge className="bg-violet-600 text-white font-black  text-[10px]  flex items-center gap-1.5 px-3">
                  {q.priceChangeType === "DECREASED" && (
              ...
              {q.quotationDetails?.[0]?.requestedRevision &&
                !q.quotationDetails?.[0]?.hasBeenRevised && (
                  <Badge className="bg-orange-500 text-white font-black  text-[10px]  px-3">
                    Revision Requested
                  </Badge>
                )}
            </div>
          ...
          {(isAccepted || isEnquiryCompleted) && (
            ...
            >
              ...
              <span className="font-black">
                {isAccepted ? "Offer Accepted" : "Enquiry Closed"}
              </span>
            </div>
          )}
        </div>
          ...
          <Card className="rounded-3xl border-none shadow-xl shadow-black/5 bg-white overflow-hidden">
            ...
            <CardContent className="p-0">
                        ...
                        {li.itemListing?.attachments &&
                          li.itemListing.attachments.length > 0 && (
                            <div className="ml-13 mt-4 space-y-3">
                              <p className="text-[10px] font-black   text-primary/50">
                                Attached Media & Documents
                              </p>
                              <div className="flex flex-wrap gap-3">
                                {li.itemListing.attachments.map(
                                  (att: {
                                    id: string;
                                    media?: { url: string };
                                    document?: {
                                    ...
                                    if (att.media) {
                                      return (
                                        <a
                                          ...
                                          target="_blank"
                                          rel="noreferrer"
                                          className="group relative h-16 w-16 rounded-xl overflow-hidden border border-border flex items-center justify-center bg-muted/30"
                                        >
                                          <img
                                            src={att.media.url}
                                            alt="Attachment"
                      ...
                      <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-2 shrink-0">
                        ...
                        {li.isNegotiable &&
                          ...
                          !isEnquiryCompleted && (
                            <Badge
                              variant="outline"
                              className="text-[9px] font-black  text-secondary border-secondary/20 bg-secondary/5"
                            >
                              Negotiable
                            </Badge>
                          )}
              ...
              <div className="p-6 md:p-8 bg-primary/5 border-t border-primary/10 flex justify-between items-center">
                <div className="space-y-1">
                  <p className="text-sm font-black   text-primary/60">
                    Total Quotation Value
                  </p>
                  <p className="text-xs text-muted-foreground font-medium">
                    Inclusive of basic charges
                  </p>
                </div>
                <div className="text-right">
                  ...
                  {q.originalTotalAmount &&
                    q.originalTotalAmount !== totalAmount && (
                      <p className="text-[11px] font-bold text-muted-foreground mt-1">
                        ...
                        >
                          {q.priceChangeType === "DECREASED"
                            ? "Saved"
                            : "Changed by"}{" "}
                          ₹{Math.abs(q.priceDifference || 0).toLocaleString()}
                        </span>
                      </p>
                    )}
                </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <p className="font-black text-primary">
                          {format(
                            new Date(q.quotationDetails[0].expectedDate),
                            "PPP",
                          )}
                        </p>
                      </div>
            ...
            <Card className="rounded-3xl border-none shadow-xl shadow-black/5 bg-linear-to-b from-primary/5 to-white overflow-hidden">
              <CardContent className="p-6 space-y-6">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="w-full h-12 rounded-xl mt-4 font-bold border-primary text-primary hover:bg-primary hover:text-white transition-all"
                >
